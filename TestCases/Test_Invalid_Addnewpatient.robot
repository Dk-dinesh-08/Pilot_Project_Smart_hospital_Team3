...
Library    DataDriver    file=../TestData/InvalidNewPatientData.xlsx   sheet_name=Sheet1    encoding=utf_8      dialect=unix
Test Setup    Open the Browser with URL
Test Teardown    close the browser
Resource    ../Resources/GenericResources.robot
Resource    ../Resources/LoginResources.robot
Resource    ../Resources/DoctorResources.robot
Test Template    Unsuccessfull addition of new patient 
...
*** Keywords ***
Unsuccessfull addition of new patient
